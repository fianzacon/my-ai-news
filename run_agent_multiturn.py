...
# In-memory store for chat histories. Not suitable for production.
...
async def run_graph_background(run_id: str, topic: str, user_id: str, chat_history: list):
    ...
    inputs = {"topic": topic, "chat_history": chat_history, "langfuse_handler": langfuse_handler}
    ...
    try:
        ...
        # Update chat history
        chat_histories[user_id].append(("user", topic))
        chat_histories[user_id].append(("assistant", final_output_md))
